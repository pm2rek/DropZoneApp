...
<body>
    ...
    <!-- Navigation -->
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Aircrafts</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form:form role="form" method="post" modelAttribute="aircraft">
                                        <div class="form-group">
                                            <label>Aircraft Name</label>
                                            <form:errors path="name" cssClass="error" element="div"/>
                                            <form:input path="name" class="form-control" placeholder="Cessna 206"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Registration</label>
                                            <form:errors path="registration" cssClass="error" element="div"/>
                                            <form:input path="registration" class="form-control" placeholder="SP-JAV"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Passengers Limit</label>
                                             <input name="maxPassengers" type="number" class="form-control"/>
                                        </div>
                                         <div class="form-group">
                                            <label>Ticket Price</label>
                                            <input name="ticketPrice" type="number" class="form-control"/>
                                        </div>
