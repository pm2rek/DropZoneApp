...
<body>
    ...
    <!-- Navigation -->
        ...
        <div id="page-wrapper">
           <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Parachutes</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form:form role="form" method="post" modelAttribute="parachute">
                                        <div class="form-group">
                                            <label>Main Parachute</label>
                                            <form:errors path="mainParachuteName" cssClass="error" element="div"/>
                                            <form:input path="mainParachuteName" class="form-control" placeholder="ex. Spectre 170"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Reserve Parachute</label>
                                            <form:errors path="reserveParachuteName" cssClass="error" element="div"/>
                                            <form:input path="reserveParachuteName" class="form-control" placeholder="ex. Nano 109"/>
                                        </div>
                                        <div class="form-group">
                                            <label>ADD</label>
                                            <form:errors path="ADDName" cssClass="error" element="div"/>
                                            <form:input path="ADDName" class="form-control" placeholder="Cypres"/>
                                        </div>
                                         <div class="form-group">
                                            <label>Reserve Parachute Expiration Date</label>
                                            <input type="date" name="expiration" class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Insurance Number</label>
                                            <form:errors path="user" cssClass="error" element="div"/>
                                            <form:select path="user.id" items="${users}" itemlabel="fullName" itemValue="id" class="form-control"/>
                                        </div>
